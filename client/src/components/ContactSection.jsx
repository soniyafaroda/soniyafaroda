  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please try again or email me directly at soniya.faroda.connect@gmail.com",
        variant: "destructive"
      });
    } finally {
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-accent/30 rounded-lg sm:rounded-xl transition-all duration-300">
                ...
                <div>
                  ...
                  >
                    soniya.faroda.connect@gmail.com
                  </a>
                </div>
              </div>
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/soniyafaroda/",
                  },
                  {
                    icon: Youtube,
                    label: "YouTube",
                    url: "https://youtube.com/@soniyafaroda",
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/soniyafaroda",
                  },
