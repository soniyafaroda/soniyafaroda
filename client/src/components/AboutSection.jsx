...
export const AboutSection = () => {
  ...
  const achievements = [
    { number: "7+", label: "Projects", icon: <Briefcase className="h-5 w-5" />, suffix: "" },
  ...
  const features = ["Frontend Development expertise", "Clean, maintainable code", "Performance optimization", "Agile methodology", "24/7 support", "Timely delivery"];

  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/soniyafaroda" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/soniyafaroda/" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:soniya.faroda.connect@gmail.com" }
  ];
  ...
  const tabContent = {
    ...
    professional: "I've delivered 10+ successful projects using modern technologies. I specialize in scalable architecture and performance optimization.",
  ...
  const handleDownload = () => {
    ...
    link.href = '/Soniya_Faroda_Resume.pdf'; // Must be in public folder
    link.download = '/Soniya_Faroda_Resume.pdf';
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-2xl transition-all duration-500 group-hover:border-primary/40 group-hover:scale-105 md:group-hover:scale-110 relative">
                      <img src="/Passport-Size-Photo.jpeg" alt="Soniya Faroda" className="w-full h-full object-cover" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Soniya Faroda</h2>
              ...
              <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-background/50 rounded-xl border border-border">
                ...
                <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
                  {socialLinks.map((social, index) => (
                    <a key={index} href={social.href} target="_blank" className="p-2 bg-background rounded-lg text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all duration-300 hover:scale-110">{social.icon}</a>
                  ))}
                </div>
              </div>
            </div>
