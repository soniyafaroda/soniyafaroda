...
const navItems = [
  ...
  { name: "Blog", href: "https://aoneportfolio.com", icon: BookOpen },
];
  ...
  return (
    <>
      ...
      >
        ...
        {/* GitHub Button */}
        <motion.a
          href="https://github.com/soniyafaroda" 
          target="_blank"
        ...
        {/* LinkedIn Button */}
        <motion.a
          href="https://linkedin.com/in/soniyafaroda" 
          target="_blank"
          rel="noopener noreferrer"
          className={cn(
            "p-2 rounded-full bg-white/80 dark:bg-black/80 backdrop-blur-md",
        ...
        {/* YouTube Button */}
        <motion.a
          href="https://www.youtube.com/@soniyafaroda"
          target="_blank"
          rel="noopener noreferrer"
          className={cn(
            "p-2 rounded-full bg-white/80 dark:bg-black/80 backdrop-blur-md",
