...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/soniyafaroda/", label: "LinkedIn" },
    { icon: <Youtube size={18} />, href: "https://youtube.com/@soniyafaroda", label: "YouTube" },
    { icon: <Github size={18} />, href: "https://github.com/soniyafaroda", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "soniya.faroda.connect@gmail.com", href: "mailto:soniya.faroda.connect@gmail.com" },
    { icon: <Phone size={16} />, text: "+917014187078", href: "tel:+917014187078" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Soniya</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Junior Software Developer | Passionate about building impactful web applications and learning new technologies.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} Soniya. All rights reserved.</p>
            </div>
